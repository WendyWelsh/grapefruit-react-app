...
class CoachLandingPage extends React.Component {
  ...
  componentDidMount() {
    axios
      .get(`${host}/coach/clients/` + this.props.match.params.id, {
        headers: {
  ...
  directToMacroList() {
    this.props.history.push(
      "/coach/client/" + this.props.match.params.id + "/macroList"
    );
  }
  directToWorkoutList() {
    this.props.history.push(
      "/coach/client/" + this.props.match.params.id + "/workout"
    );
  }
    ...
    return (
      <div className="CoachLandingPage">
        ...
        <Paper style={paper}>
          <Button
            style={buttonStyle}
            onClick={this.directToMacroList}
            color="inherit"
          >
            Macros
          </Button>
          ...
          <Button
            style={buttonStyle}
            onClick={this.directToWorkoutList}
            color="inherit"
          >
            Workouts
          </Button>
